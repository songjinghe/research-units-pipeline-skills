...
| `graduate-paper` | 把现有中文毕业论文材料重组成 thesis workflow | pipeline + thesis skill packages | [说明](graduate-paper.zh-CN.md) |

## 三条并列的 Review 产品

这三条现在是并列入口，不再是一个流程里的轻重档位：
...
2. 再打开与你任务对应的 workflow guide。
3. 如果你需要执行细节，再看 `../pipelines/` 里的 pipeline 合同。
