...
def main() -> int:
    ...
    from tooling.ideation import DirectionCard, parse_idea_brief, read_jsonl, score_direction_cards, screening_table_markdown, write_jsonl, write_markdown
    ...
    rows = score_direction_cards(cards, focus_clusters=brief.get('focus_clusters') or [])
