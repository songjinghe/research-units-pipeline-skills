...
↓ [C0-C1] Retrieve 1200+ candidates (target 1500+) → core set=300 (A150++ default; arXiv can backfill metadata)
...
Config (A150++ default): `draft_profile: survey` / `evidence_mode: abstract` / `core_size: 300` / `per_subsection: 28` (see `queries.md`).
