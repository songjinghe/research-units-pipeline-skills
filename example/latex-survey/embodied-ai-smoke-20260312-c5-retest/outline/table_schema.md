...
- Goal (from `GOAL.md`): Embodied AI survey
- Subsections (H3) detected: 12
- Evidence packs: 12
- Briefs: 12
...
- Question: What representative approaches dominate this area, and what do they assume about the design assumptions?
- Row unit: work/system line (a paper or system family).
- Columns (example):
  - Work (short name)
  - Core idea (1 short phrase)
  - Design assumption (1 short phrase)
  - Key refs (2-4 cite keys)
- Evidence mapping:
  - Core idea / design assumptions: `outline/evidence_drafts.jsonl` (definitions_setup + concrete_comparisons)
