...
<!-- BEGIN CHECKPOINT:C0 -->
## Kickoff — agent survey (LLM agents) LaTeX survey

- Pipeline: `pipelines/arxiv-survey-latex.pipeline.md`
- Workspace: `workspaces/e2e-agent-survey-latex-verify-20260119-120720`
- Workspace name: `e2e-agent-survey-latex-verify-20260119-120720`
