...
| 工作流 | 核心问题 | 主要输出 |
|---|---|---|
| `latex-survey` | 如何把一个文献领域综合成论文 | draft + 可选 PDF |
...
- [readme/latex-survey.zh-CN.md](latex-survey.zh-CN.md)
...
- survey/PDF：[readme/latex-survey.zh-CN.md](latex-survey.zh-CN.md)
